                ...
                @csrf
                  <div class="col-xl-6">
                    <div class="card-body p-md-5 text-black">
                      ...
                      <div class="row">
                        <div class="col-md-6 mb-4">
                          <div class="form-outline">
                            <input name='name' type="text" id="form3Example1m" class="form-control form-control-lg" />
                      ...
                      <div class="form-outline mb-4">
                        <input name='password_confirmation' type="password" id="form3Example8" class="form-control form-control-lg" />
                        <label class="form-label" for="form3Example8">Conferma Password</label>
                      </div>
